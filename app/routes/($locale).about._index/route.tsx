...
export const meta: MetaFunction<unknown, { "root": typeof rootLoader }> = ({ matches }) => {
  ...
  return [
    ...
    { name: "description", content: rootMatch?.translations["about.page.description"] },

    // ✅ Open Graph
    { property: "og:title", content: rootMatch?.translations["about.page.og.title"] },
    { property: "og:description", content: rootMatch?.translations["about.page.og.description"] },
    ...
    { name: "twitter:title", content: rootMatch?.translations["about.page.twitter.title"] ?? rootMatch?.translations["about.page.title"] },
    { name: "twitter:description", content: rootMatch?.translations["about.page.twitter.description"] ?? rootMatch?.translations["about.page.description"] },
