...
const DefinitionSection = forwardRef<HTMLElement>((props, ref) => {
  ...
  return (
    <section
      ref={ref}
      className="h-screen relative bg-no-repeat bg-[length:150%_auto] bg-[position:100%_20%] lg:bg-[length:55%_auto] xl:bg-[length:55%_auto] 2xl:bg-[length:auto_50%] bg-[url(/images/definition-about.png)] lg:bg-[url(/images/definition-about.png)] lg:bg-right xl:bg-[position:80%] overflow-auto overscroll-none"
      {...props}
    >
  ...
  <div aria-hidden className="lg:hidden pointer-events-none absolute left-0 right-0 top-0 h-1/2" />
  ...
  <div className="bg-gradient-to-t from-90% from-[#1b1b1b] lg:from-transparent w-full">
        ...
        <div aria-hidden className="pointer-events-none absolute left-0 right-0 bottom-0 h-20 bg-gradient-to-b from-[#1b1b1b] to-transparent z-10" />
      </div>
    </section>
  );
});
